...
class MakeItFlatWhite: UIViewController {
    ...
    func setUpScrollView() {
        ...
        func setUpTopImage() {
            ...
            topImage.image = UIImage(named: "flatwhite")
            }
    ...
    func setUpIntroText() {
        ...
        introText.text = "This favorite is all about one thing, micro bubbles. For this you will need espresso machine and milk frother"
    }
    ...
    func setUpStepTwoText() {
        ...
        stepTwoText.text = "Empty the cup and either using a pod or coffee grinds get your machine and brew your espresso stright into the cup"
    }
    ...
    func setUpStepFourText() {
        ...
        stepFourText.text = "Add your warm foamed milk to your espresso"
    }
