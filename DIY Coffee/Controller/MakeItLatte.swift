...
class MakeItLatte: UIViewController {
    ...
    func setUpScrollView() {
        ...
        func setUpTopImage() {
            ...
            topImage.image = UIImage(named: "Latte")
    ...
    func setUpIntroText() {
        ...
        introText.text = "A great classic! A blend of Espresso and milk, topped with a touch of milk foam"
        }
    ...
    func setUpStepOneText() {
     ...
     func setUpStepTwoText() {
         ...
         stepTwoText.text = "Empty the cup and either using a pod or coffee grinds get your machine and brew your lungo measure (110 ml / 4 oz) espresso stright into the cup"
     }
    ...
    func setUpStepThreeText() {
        ...
        stepThreeText.text = "Warm 220 ml / 7.5 oz of milk in your own applience"
    }
    ...
    func setUpStepFourText() {
        ...
        stepFourText.text = "Add your warmed milk to your espresso with touch of foam on top"
    }
    ...
    func setUpStepFourImage() {
        ...
        stepFourImage.image = UIImage(named: "Foam")
